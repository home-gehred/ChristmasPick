...
namespace Common.Test
{
  ...
  public class PersonCollectionFixture : BaseFixture
  {
    ...
    public void SortPersonCollectionByOldestToYoungest()
    {
      ...
      Assert.IsTrue((testList.GetAt(0) == MadelineG));
      Assert.IsTrue((testList.GetAt(1) == CecilaG));
      Assert.IsTrue((testList.GetAt(2) == MaxG));
      Assert.IsTrue((testList.GetAt(3) == CharlotteG));
    }
